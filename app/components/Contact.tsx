...
const Contact = () => {
  ...
  return (
    <>
            ...
            >
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      {info.href !== "#" ? (
                        <a href={info.href} className="font-semibold text-gray-800 transition-colors hover:text-blue-600">
                          {info.value}
                        </a>
                      ) : (
              ...
              <div className="mt-8 text-center">
                <a
                  ...
                  className="inline-flex items-center px-8 py-4 space-x-3 text-lg font-semibold text-white transition-all duration-300 shadow-lg bg-gradient-to-r from-green-400 to-blue-500 rounded-2xl hover:from-green-500 hover:to-blue-600"
                >
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full px-4 py-3 text-gray-900 transition-all border border-gray-300 rounded-lg outline-none bg-gray-50 focus:border-blue-500 focus:ring-blue-500"
                      required
                    />
                  </div>
                  <div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center w-full px-8 py-4 space-x-2 font-semibold text-white transition-colors rounded-lg shadow-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
                ...
                {submitStatus === "success" && (
                  <motion.div
                    ...
                    className="mt-4 font-semibold text-center text-green-500"
                  >
                ...
                {submitStatus === "error" && (
                  <motion.div
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="mt-4 font-semibold text-center text-red-500"
                  >
      ...
      <footer className="w-full py-6 text-sm text-center text-gray-500">
        All rights reserved &copy; {new Date().getFullYear()} vincent otieno
      </footer>
    </>
  )
}
